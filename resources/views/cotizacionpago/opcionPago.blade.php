...
<head>
    ...
    <script src="{{ url('/js/cotizacionOpcionPago.js') }}"></script>
    <style>
        .content-wrapper {
...
<input type="text" id="categoria" hidden value="{{$categoria}}">
<input type="text" id="cotizacion" hidden value="{{$cotizacion}}">
<input type="text" id="candidato" hidden value="{{$candidato}}">
<input type="text" id="opcion" hidden value="{{$opcion}}">
                        ...
                        <div>
                            ...
                            <div id="contenedorCampos" hidden>
                                <div class="cCotizacion">
                                    <div class="mt-2 row">
                                        <label for="telefono" style="color: white;font-size: 19px;">Número de teléfono:</label>  
                                    ...
                                    <div class="mt-2 row">
                                        <label for="adicional" style="color: white;font-size: 19px;">Datos adicionales:</label> 
                        ...
                        <div>                            
                            ...
                            <div id="contenedorPago2" hidden>
                                        <div class="cCotizacion">
                                            ...
                                            <div class="mt-2 row">
                                                <label for="txtComprobante" style="color: white;">Número de comprobante</label> 
                                                <input type="text" placeholder="Número de comprobante" class="cajatextopago" id="txtComprobante">
                                                <label style="color:red;" class="error" id="errorComprobante" hidden>Debe ingresar un número de comprobante</label>
                                            </div><br><br>
                                            <div class="mt-2 row">
